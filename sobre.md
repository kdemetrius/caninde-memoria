...
A curadoria cultural, histórica e memorialística é conduzida por **Pedro Paulo Paulino**, responsável pela indicação, seleção e contextualização das fontes culturais, históricas e documentais relacionadas a Canindé.

O projeto nasce, portanto, como uma construção conjunta, unindo tecnologia e memória local para preservar e tornar acessível a história de Canindé às futuras gerações.
...
Este projeto é uma iniciativa independente de preservação da memória de Canindé. Seu desenvolvimento será feito de forma gradual, com respeito às fontes, às pessoas citadas e à história local.
